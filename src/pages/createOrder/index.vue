<template>
    <div class="container">
        ...
        <van-button @click="submit" class="submit" type="primary" size="large">确认</van-button>
        <van-popup
        ...
        >
          <van-picker
            ...
            @confirm="componionConfirm"
            @cancel="showComponion = false"
          />
        </van-popup>
        <van-dialog 
          v-model:show="showCode" :show-confirm-Button="false">
          <div>微信支付</div>
          <van-image>
            <van-icon name="close" @click="closeCode" />
            <img :src="codeImg" alt="" />
          </van-image>
...
//就诊医院弹出的变量,弹出层效果用popup，下拉效果用piker
